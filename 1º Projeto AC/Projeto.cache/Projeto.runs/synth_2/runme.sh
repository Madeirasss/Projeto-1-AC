...
HD_PWD='C:/Users/andre/Desktop/Projeto/Projeto.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log placa_mae.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source placa_mae.tcl
