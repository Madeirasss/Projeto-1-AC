...
HD_PWD='C:/Users/andre/Desktop/Projeto/Projeto.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log placa_mae.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source placa_mae.tcl -notrace
